    ...
    var options = {
        ...
        setProgressBar = function ($el, score) {
            ...
            if (score < options.scores[0]) {
                ...
                progressbar.find(".color-bar").css("width", "5%").css("background-color", "blue");
                if (options.showVerdicts) {
                    $verdict.text(options.verdicts[0]);
                }
            } else if (score >= options.scores[0] && score < options.scores[1]) {
                progressbar.addClass("progress-danger").removeClass("progress-warning").removeClass("progress-success");
                progressbar.find(".color-bar").css("width", "25%").css("background-color", "green");
                if (options.showVerdicts) {
                ...
                progressbar.find(".color-bar").css("width", "50%").css("background-color", "yellow");
                if (options.showVerdicts) {
                    $verdict.text(options.verdicts[2]);
                }
            } else if (score >= options.scores[2] && score < options.scores[3]) {
                progressbar.addClass("progress-warning").removeClass("progress-danger").removeClass("progress-success");
                progressbar.find(".color-bar").css("width", "75%").css("background-color", "orange");
                if (options.showVerdicts) {
                ...
                progressbar.find(".color-bar").css("width", "100%").css("background-color", "red");
                if (options.showVerdicts) {
        ...
        progressWidget = function () {
            return '<div class="progress" style="height: 5%; background-color: transparent; position: relative"><div class="color-bar" style="height: 10px; opacity: 0.4"></div></div>';
        },
        ...
        methods = {
            init: function (settings) {
                ...
                return this.each(function (idx, el) {
                    ...
                    progressbar.find(".color-bar").css("width", "0%");
